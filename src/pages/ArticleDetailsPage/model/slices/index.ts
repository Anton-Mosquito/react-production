...
export const articleDetailsPageReducer =
    combineReducers<ArticleDetailsPageSchema>({
        comments:
            articleDetailsCommentsReducer as unknown as ArticleDetailsCommentSchema,
        recommendations:
            articleDetailsRecommendationReducer as unknown as ArticleDetailsRecommendationSchema,
    });
